    ...
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
      ...
      <ul
        ...
        <router-link to="/product">
          <li><a class="text-sm text-gray-400 hover:text-gray-500" href="#">Product</a></li>
        </router-link>
        ...
        <router-link to="/categori">
        <li><a class="text-sm text-gray-400 font-bold" href="#">Categori</a></li>
        </router-link>
        <li class="text-gray-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
            viewBox="0 0 24 24">
        ...
        <li><a class="text-sm text-gray-400 hover:text-gray-500" href="#">Brand</a></li>
        </router-link>
        <li class="text-gray-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
            viewBox="0 0 24 24">
      ...
      <div v-else class="flex md:order-2">
        ...
        <div class="flex md:order-4 md-6">
