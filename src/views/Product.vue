<template>
  <div v-for="products in  getProducts" :key="products.id"
    ...
    <div>
      <div class="mt-4 px-5 pb-5">
        <a href="#">
          <h5 class="text-xl tracking-tight text-slate-900">{{ products.name }}</h5>
        </a>
        <div class="mt-2 mb-5 flex items-center justify-between">
          <p>
            <span class="text-3xl font-bold text-slate-900">{{ products.base_price }}</span>
          </p>
        ...
        <RouterLink :to="'/product/detailproduct/' + products.slug">
        <a href="#"
