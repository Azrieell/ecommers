<template>
  <div v-for="categori in  getCategori" :key="categori.id"
    ...
    <div>
      <div class="mt-4 px-5 pb-5">
        <a href="#">
          <h5 class="text-xl tracking-tight text-slate-900">{{ categori.name }}</h5>
        </a>
...
<script>
  ...
  export default {
    computed: {
      ...mapGetters('categori', ['getCategori']),
    },
    methods: {
      ...mapActions('categori', ['fetchCategori']),
    },
    created() {
      this.fetchCategori();
    },
